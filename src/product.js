export default {
  ...
  selectableAttributes: [
    ...
    { name: "Beden", values: ["M", "L", "XL"] },
  ],
  productVariants: [
    {
      id: "432081",
      attributes: [
        { name: "Beden", selectable: true, value: "L" },
        { name: "Renk", selectable: true, value: "Siyah" },
      ],
      images: [
    ...
    },
    {
      id: "432110",
      attributes: [
        { name: "Beden", selectable: true, value: "M" },
        { name: "Renk", selectable: true, value: "Lacivert" },
      ],
      images: [
    ...
    },
    {
      id: "432111",
      attributes: [
        { name: "Beden", selectable: true, value: "XL" },
        { name: "Renk", selectable: true, value: "Lacivert" },
      ],
      images: [
        "https://n11scdn.akamaized.net/a1/500/06/12/21/57/46288336.jpg",
  ...
  baremList: [
    { minimumQuantity: 120, maximumQuantity: 599, price: 9.5 },
    { minimumQuantity: 600, maximumQuantity: 799, price: 8.46 },
    { minimumQuantity: 800, maximumQuantity: 2147483647, price: 7.13 },
  ],
};
